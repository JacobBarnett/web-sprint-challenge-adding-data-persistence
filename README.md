...
1. Explain the difference between Relational Databases and SQL. SQL is a query language and relational databases use SQL
2. Why do tables need a Primary Key? it makes sure it has row-level accessibility
3. What is the name given to a table column that references the Primary Key on another table? a foregin key
4. What do we need in order to have a _many to many_ relationship between two tables? it happens when multiple records in a table connect with multiple records of a different table
